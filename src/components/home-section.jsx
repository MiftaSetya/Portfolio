...
export default function HomeSection() {
    return (
        <section id="home" className='flex px-48 mt-24 scroll-mt-40 justify-center items-center gap-12'>
            <div className='relative w-[580px] aspect-square border-[16px] border-white rounded-full shadow-lg overflow-hidden'>
                <Image
