...
export default function AboutSection() {
    return (
        <section id="about" className='container text-black px-30 mt-16 scroll-mt-5 pt-16'>
            {/* Languages and Tools */}
            ...
            <div className='flex gap-6 mb-10'>
                <div className='w-[420px] h-[270px] bg-white rounded-xl border border-gray-200 overflow-hidden 
